...
export default function LessonQuizGame({ quiz, userId, lessonId, onComplete }: LessonQuizGameProps) {
  ...
  const startQuiz = useCallback(() => {
    const picked = pickQuizQuestions(quiz.questionBank);
  ...
  if (phase === "intro") {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-bold font-heading text-foreground">{quiz.title}</h3>
        ...
        <p className="text-muted-foreground text-sm max-w-md mx-auto">{quiz.description}</p>
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-yellow-400">{saving ? "..." : `+${displayXP}`}</div>
